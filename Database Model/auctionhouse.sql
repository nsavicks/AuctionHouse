CREATE DATABASE  IF NOT EXISTS `auction_house_db` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci */;
...
CREATE TABLE `auctions` (
  ...
  CONSTRAINT `FK_category` FOREIGN KEY (`category`) REFERENCES `auction_categories` (`category_id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2019-04-26 16:37:22
